...
import { Plus, Search, Package, Edit, Power, Eye } from 'lucide-react';
...
import { Category, CATEGORY_LABELS, CATEGORY_COLORS } from '@/types/erp';
...
export default function ProdutosPage() {
  ...
  // Group products by category for banners
        ...
        {categories.map((cat) => {
          ...
          return (
            <div
              key={cat}
              className={cn(
                'category-banner cursor-pointer hover:opacity-90 transition-opacity',
                CATEGORY_COLORS[cat]
              )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredProducts.map((product) => (
            ...
            >
              ...
              {product.image && (
                <div
                  className="h-32 bg-muted/30 flex items-center justify-center cursor-pointer relative group"
                  onClick={() => setPreviewImage({ url: product.image!, name: product.name })}
                >
                  <img
                    src={product.image}
                    alt={product.name}
              ...
              <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge
                    ...
                    className={cn(
                      'ml-2 shrink-0',
                      product.active ? 'bg-status-success' : 'bg-muted'
                    )}
                  >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={cn(
                        'font-medium',
                        product.stock < 10 && 'text-status-error'
                      )}
                    >
                      {product.stock} un.
                    </span>
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      handleToggleStatus(product.id, product.name, product.active)
                    }
                  >
